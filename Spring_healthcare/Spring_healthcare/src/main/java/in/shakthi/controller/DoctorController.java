...
//	private MyMailUtil mailUtil;
	...
	//1. show Register page
				...
				) 
		{
			...
			createDynamicUi(model); // for dynamic drop down in register
...
//								"SUCCESS", 
//								message,
//								new ClassPathResource("/static/myres/Sookshmasfullstack.pdf"));
//					}
//				}).start();
//			}
				...
				)
		{
			...
			try {
				...
				createDynamicUi(model); //for dynamic drop  down
				page = "DoctorEdit";
			} catch (DoctorNotFoundException e) {
				e.printStackTrace();
